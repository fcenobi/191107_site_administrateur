...
<body>
    ...
    <!--Carousel-->
    <div class="carousel slide home-slide carousel-fade" data-ride="carousel" data-interval="3000">
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item">
                <div class="img"><img class="d-block img-fluid" src="images/logout.jpg" alt="slide 2"></div>
            </div>
            <div class="carousel-item">
                <div class="img"><img class="d-block img-fluid" src="images/logout2.jpg" alt="slide 3"></div>
            </div>
            <div class="carousel-item">
                <div class="img"><img class="d-block img-fluid" src="images/logout3.jpg" alt="slide 5"></div>
            </div>
        </div>
    </div>
    <!--End Carousel-->
    ...
    <!--End Navbar-->
<!--login-->
<div class ="container-fluid row col-sm-12 col-lg-12 dashboard justify-content-center">
